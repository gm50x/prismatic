...
export class PostCategoryService implements IPrismaCrud<PostCategory> {
  ...
  async getOne(postCategoryWhereUniqueInput: Prisma.CommentWhereUniqueInput): Promise<PostCategory | null> {
  ...
  async delete(where: Prisma.PostCategoryWhereUniqueInput): Promise<PostCategory> {
